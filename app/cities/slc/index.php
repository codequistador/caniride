...
<body>
	...
	<div class="millcreek <?php echo $mcstatus; ?> center">
		<div class="inner">
	...
	<div class="city_creek <?php echo $ccstatus; ?> center">
		<div class="inner">
